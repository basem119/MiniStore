...
namespace MiniStore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            _logger = (ILogger<RegisterModel>)logger;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
               ...
               // await _userStore.SetUserNameAsync(user, Input.Email, CancellationToken.None);
                ...
                var result = await _userManager.CreateAsync((Customer)user, Input.Password);

                if (result.Succeeded)
                {
                    _logger.LogInformation("User created a new account with password.");
                    await _userManager.AddToRoleAsync((Customer)user,clsRole.roleUser );
